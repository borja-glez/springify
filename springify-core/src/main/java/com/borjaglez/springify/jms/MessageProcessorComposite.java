...
/**
 * Composite implementation of a {@link MessagePostProcessor}. Will iterate over
 * the configured collection of processors and execute them in order. Will take
 * the given ordering into account when configuring.
 *
 * @author Marten Deinum
 * @see <a href="https://github.com/mdeinum/spring-utils">https://github.com/mdeinum/spring-utils</a>
 */
