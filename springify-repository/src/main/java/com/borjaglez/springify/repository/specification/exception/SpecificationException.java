 ...
 */
package com.borjaglez.springify.repository.specification.exception;
...
public class SpecificationException extends RuntimeException {
	...
	public SpecificationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
